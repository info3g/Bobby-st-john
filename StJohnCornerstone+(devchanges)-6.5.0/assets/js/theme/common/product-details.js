...
export default class ProductDetails extends ProductDetailsBase {
    ...
    setProductVariant() {
        ...
        // console.log("api variant list: ", utils.api.productVariantslist);
        // console.log("api variant list2: ", utils.api.productVariant);
        // console.log("prod options: ", utils.api.productAttributes); 
        // console.log("view model: ", utils.api.product.getViewModel);
        // console.log("productAttributes: ", utils.api.productAttributes.);
        // console.log("ProductDetails: ", utils.api.product.ProductDetails);
        // console.log("ProductDetails : ", utils.tools.ProductDetails);

        const productId = $('[name="product_id"]').val();

        // console.log($('[name="product_id"]'));
        // if ($('[name="product_id"]')) {
        //     let prodId = $('[name="product_id"]').val();
        // }

        // console.log("prodId: ", prodId);

        utils.api.product.getById(productId, { }, (err, response) => {
            if (err) return;
        });
